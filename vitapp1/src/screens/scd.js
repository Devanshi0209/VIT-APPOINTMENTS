...
const scd=({navigation})=>{
	const [r,setr]=useState('');
	const {state,fetchslotscopedean,confirmtheslot,removeexpiredslots}=useContext(slotcontext);
...
return (
	...
	<NavigationEvents onWillFocus={fetchslotscopedean} />
	<Spacer>
	<Header
