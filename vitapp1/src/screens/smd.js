...
const smd=({navigation})=>{
	const {state,fetchslotsmecdean,confirmtheslot,removeexpiredslots}=useContext(slotcontext);
...
return (
	...
	<NavigationEvents onWillFocus={fetchslotsmecdean} />
<Spacer>
	<Header
