...
const senh=({navigation})=>{
	const {state,fetchslotsensehod,confirmtheslot,removeexpiredslots}=useContext(slotcontext);
...
return (
	...
	<NavigationEvents onWillFocus={fetchslotsensehod} />
	<Spacer>
	<Header
