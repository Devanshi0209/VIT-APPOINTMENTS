...
const sih=({navigation})=>{
	const {state,fetchslotsitehod,confirmtheslot,removeexpiredslots}=useContext(slotcontext);
...
return (
	...
	<NavigationEvents onWillFocus={fetchslotsitehod} />
	<Spacer>
	<Header
