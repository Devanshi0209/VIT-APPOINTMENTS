...
const seld=({navigation})=>{
	const {state,fetchslotselectdean,confirmtheslot,removeexpiredslots}=useContext(slotcontext);
...
return (
	...
	<NavigationEvents onWillFocus={fetchslotselectdean} />
	<Spacer>
	<Header
