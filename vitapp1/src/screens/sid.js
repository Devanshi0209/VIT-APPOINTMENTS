...
const sid=({navigation})=>{
	const {state,fetchslotsitedean,confirmtheslot,removeexpiredslots}=useContext(slotcontext);
...
return (
	...
	<NavigationEvents onWillFocus={fetchslotsitedean} />
	<Spacer>
	<Header
