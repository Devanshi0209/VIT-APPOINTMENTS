...
const selh=({navigation})=>{
	const {state,fetchslotselecthod,confirmtheslot,removeexpiredslots}=useContext(slotcontext);
...
return (
	...
	<NavigationEvents onWillFocus={fetchslotselecthod} />
			<Spacer>
	<Header
